...
uint256 hashGenesisBlock("0x833793baf8c03d9c8324122d0cf29b7cde0c6a2d6320085df76993eba97fa15e");
...
const string strMessageMagic = "WampumCoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal wampumcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WampumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "We've seen this happen before, right in these United States.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390606832; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0xeffaa6de8b339c72be4f8fd239a6ad3134ac5041b423bd200e3e6d4bab7dbe58"));
...
unsigned char pchMessageStart[4] = { 0xd9, 0xd9, 0xdd, 0xfc };
